...
class BrasilIO:
    ...
    def download(self, dataset, table_name):
        ...
        url = f"https://brasil.io/api/v1/dataset/{dataset}/{table_name}/data/?format=api"

#        request = Request(url, headers=self.headers)
        request = Request(url, headers=api.api_headers)
...
if __name__ == "__main__":
    api = BrasilIO("76a8419d5dfdb77c13abe53d03d7382178a03cb2")
